...
" Enable high contrast color scheme for gruvbox dark mode
...
" Allows pasting after a delete.
" Sends the deleted text to the black hole register.
" Then pastes from the last deleted register, 0.
...
" Turn on dynamic numbers. Standard numbers while in insert mode and relative numbers in normal mode.
